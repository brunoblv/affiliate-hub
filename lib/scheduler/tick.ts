 ...
 * 1. Dispara os ScheduleSlot cujo horário bateu com o horário atual (uma vez por dia).
 * 2. Roda as AutopilotRule ativas em modo AUTOMATIC (spec §27/§28) — sem esperar horário fixo.
 * 3. Publica automaticamente as Publication já aprovadas e com horário vencido.
 */
