import { Rede, type Canal } from "@/lib/generated/prisma/client";
import { obterTokenDePagina, obterTokenMeta } from "@/lib/integrations/meta-credenciais";
...
class PublicadorInstagram implements Publicador {
  ...
  async publicar(conteudo: ConteudoParaPublicar): Promise<ResultadoPublicacao> {
    ...
    const token = await obterTokenMeta();
