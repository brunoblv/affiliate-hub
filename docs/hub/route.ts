...
/**
 * Upload de imagem do CMS. O editor chama isto ao arrastar um arquivo para o
 * corpo do post e recebe de volta a URL, que vira ![alt](url) no markdown.
 *
 * MEDIA_ROOT fica FORA de public/ e é servido por rota própria (ou pelo Nginx),
 * para que o Next não precise de rebuild a cada imagem nova.
 */

const RAIZ_MIDIA = process.env.MEDIA_ROOT ?? "/var/lib/affiliate-hub/midia";
...
export async function POST(requisicao: Request) {
  ...
  // Converte tudo para webp e limita a largura: um JPEG de celular de 4 MB vira
  // ~180 KB, e o Core Web Vitals do blog agradece.
  ...
  // O editor insere isto direto no markdown.
