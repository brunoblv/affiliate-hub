...
export async function createProjectCampaignAction(projectSlug: string, formData: FormData) {
  ...
  revalidatePath(`/admin/afiliados/${projectSlug}/campanhas`);
}

export async function setProjectCampaignStatusAction(projectSlug: string, campaignId: string, status: CampaignStatus) {
