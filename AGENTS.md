...
- Postagem automática no Facebook (affiliate-hub) segue `docs/hub/regras-postagem-facebook.md`: `content_type` obrigatório por post (`oferta_individual`/`selecao`/`conteudo_blog`/`narrativa_pessoal`), teto de 2–3 `oferta_individual`/dia por página, dedup por similaridade de título (7 dias), mix semanal mínimo de `selecao`/`narrativa_pessoal`, e suporte a link em comentário como alternativa ao link na legenda.
